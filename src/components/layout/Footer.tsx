...
const Logo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="118" height="112" viewBox="0 0 178 172" fill="none" className="w-full h-full">
      ...
      <path d="M9.2206 158.04L46.0596 102.265C49.5991 96.9061 57.4513 96.8725 61.0364 102.201L98.564 157.976C102.586 163.954 98.3025 172 91.0969 172H16.7304C9.55958 172 5.26856 164.023 9.2206 158.04Z" fill="#E33840"/>
