    ...
    <div className="max-w-7xl mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
        ...
        <div className="md:col-span-3">
          <p className="text-lg text-gray-700 font-libre leading-relaxed">
            ...
            significant gap in the market for accessible, medical-grade health tracking. This divide
            particularly affects users across different age groups and technical abilities who need
            reliable health data for informed decision-making but struggle with existing solutions'
        ...
        <div className="md:col-span-3 space-y-8">
          <div>
            ...
            <p className="text-gray-700 font-libre">
              ...
              track vital health metrics including oxygen levels, heart rate, blood pressure, and
              body temperature with medical-grade accuracy.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-700 font-libre">
              ...
              provides medical-grade accuracy through an intuitive interface tailored to different
          ...
          <div>
            ...
            <p className="text-gray-700 font-libre">
              ...
              interviews, created wireframes and prototypes, and established the design system for a
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
        ...
        <div className="md:col-span-3">
          <p className="text-gray-700 mb-8 font-libre">
            ...
            represent our target audience. These personas guided our design decisions throughout the
            project.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-32">
        ...
        <div className="md:col-span-3 space-y-8">
          <div>
            ...
            <p className="text-gray-700 font-libre">
              We interviewed 24 users across different age groups, technical abilities, and health
              needs to understand the challenges they face with current health monitoring solutions.
              We found that users universally struggled with balancing ease of use and accuracy in
              their health tracking devices.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-700 font-libre">
              ...
              health-conscious professionals seeking unobtrusive monitoring, individuals managing
              chronic conditions requiring reliable data sharing, and fitness enthusiasts needing
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600 font-libre">
                  Investigating how users of different ages and technical abilities interact with
                  health monitoring interfaces, identifying barriers to adoption, and developing
                  design principles for universal accessibility.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h4 className="text-lg font-medium mb-4 font-libre">
                ...
                <p className="text-gray-600 font-libre">
                  Exploring how different user groups prefer to view and interpret health data,
                  including preferences for numerical displays, graphs, color coding, and historical
                  trend visualization.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
        ...
        <div className="md:col-span-3 space-y-8">
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 font-libre">
              ...
              <li>Users across all age groups struggled with complex medical device interfaces</li>
        ...
        <div className="md:col-span-3 space-y-8">
          <div>
            <p className="text-gray-700 mb-4 font-libre">
              ...
              health monitoring with minimal friction. The flow accommodates different user needs
              while maintaining a consistent experience.
            </p>
            <p className="text-gray-700 mb-8 font-libre">
              Before development, I created a flowchart to map out key user interactions based on
            ...
            <p className="text-gray-700 font-libre">
              ...
              from their initial setup through daily health monitoring. It maps out key interactions
              including onboarding, vital sign recording, and data analysis, showing how the
              interface adapts to different user needs.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="md:col-span-3 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h4 className="text-lg font-medium mb-4 font-libre">For Sarah (Professional)</h4>
                <ul className="list-disc pl-5 text-gray-600 font-libre">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16 mt-32">
        ...
        <div className="md:col-span-3 space-y-8">
          <div>
            <p className="text-gray-700 font-libre">
              The ExoArm Health Monitoring Application successfully bridges the gap between consumer
              wearables and medical devices by providing:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-4 text-gray-700 font-libre">
              <li>
                <strong>Medical-grade accuracy</strong> through integration with the ExoArm sensor
              </li>
              <li>
                <strong>Intuitive interfaces</strong> tailored to different user needs and abilities
              </li>
              <li>
            ...
            <p className="text-gray-700 mt-6 font-libre">
              By deeply integrating user personas with interface design, we've created a solution
              that empowers users regardless of age or technical ability to take control of their
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8 mb-16 sm:mb-32">
        ...
        <div className="lg:col-span-3">
          <p className="text-lg text-gray-500 font-libre leading-relaxed">
            Our roadmap focuses on expanding the ExoArm Health Monitoring Application with enhanced
            features and broader accessibility. We're planning integration with healthcare
            providers' systems, developing AI-powered health insights, and creating specialized
            interfaces for additional user groups. We'll continue gathering user feedback to refine
            the experience and ensure we're meeting the evolving needs of our diverse user base.
          </p>
        </div>
      </div>
