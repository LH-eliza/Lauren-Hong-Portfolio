              ...
              <div className="md:col-span-3 space-y-8">
                <div>
                  <p className="text-gray-700 font-libre">
                    ...
                    master’s students in tech/interested in that field. To see a broader spectrum of
                    the applicant profile we focused on the primary feedback from the previous
                    iterations of the hackathon and also from our point-of views as current
                    students.
                  </p>
                </div>
              </div>
              ...
              <div className="md:col-span-3 space-y-8">
                <div>
                  ...
                  <p className="text-gray-700 font-libre">
                    ...
                    computer science there is a scarcity of time for students within these programs.
                  </p>
                </div>
                <div>
                  <p className="text-gray-700 font-libre">
                ...
                <div>
                  <p className="text-gray-700 font-libre">
                    Finally, students are interested in engaging. This application was designed with
                    the idea of branching out of the typical resume format. Students apply to tens
                    to hundreds of various applications. Thus, allowing people to remain engaged and
          ...
          <ScrollFadeIn delay={800}>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
              ...
              <div className="md:col-span-3 space-y-8">
                ...
                <div>
                  <p className="text-gray-700 font-libre">
                    <span className="font-bold">Engagement</span> - Applicants shouldn't be leaving
                    any negative emotions while filling out their application process. Since many
                    applicants leave their applications to the last minute or even wait till the
                    extended applications release- providing a feeling of dread. This should create
                    an environment that is fun so user's make it feel like it was a fun activity
                    opposed than an application and think of the process as a larger priority.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="md:col-span-3 space-y-8">
                <div>
                  <p className="text-gray-700 font-libre">
                    ...
                    filled, the left of the page is updated to tailor to fit their unique profiles.
                    In short, the users could just fill out their regular application; however, this
                    inclusion of graphics and selection allows the experience to be unique, fun, and
                    cute.
                  </p>
                </div>
              </div>
              ...
              <div className="md:col-span-3 space-y-8">
                <div>
                  <p className="text-gray-700 font-libre">
                    ...
                    students will focus the majority of their time in this portion. The user can see
                    the word count and the max word count they can use.
                  </p>
                </div>
                <div>
                  <p className="text-gray-700 font-libre">
              ...
              <div className="md:col-span-3 space-y-8">
                <div>
                  <p className="text-gray-700 font-libre">
                    ...
                    applicant can also see the word count for each section and the total word count
                    for the application.
                  </p>
                </div>
                <div>
              ...
              <div className="md:col-span-3 space-y-8">
                <div>
                  <p className="text-gray-700 font-libre">
                    ...
                    development team had to work on the backend and frontend of the application. The
                    application was built using Angular, MongoDB, Express, and Node.js. The
                ...
                <div>
                  <p className="text-gray-700 font-libre">
                    ...
                    reviews, and last minute syncs, I poured myself into every prototype and design
                    iteration. The feedback I got made all those solitary hours of scrutiny worth
                    it. Oftentimes I get so sucked into the details of my work that I forget the
                    impact it can have on the people I'm designing for. This project brought to
                    light how important it is to design for passion, not just perfection. It's
              ...
              <div className="md:col-span-3 space-y-8">
                <div>
                  <p className="text-gray-700 font-libre">
                    ...
                    uOttaHack. The feedback was positive and the application was a success. The next
                    steps would be to continue to improve the application and make it more
                    accessible to all students. The next steps are incorporating more accessibility
                    features and making the application app more interactive and connected to other
                    services our team offers such as profile cards, raffles, queues for food, and
                    more in-person event involvements.
                  </p>
                </div>
              </div>
